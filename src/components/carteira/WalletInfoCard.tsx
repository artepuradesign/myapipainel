  ...
  return (
    <Card className="bg-white/90 dark:bg-gray-800/90 border border-gray-200/50 dark:border-gray-700/50 shadow-sm backdrop-blur-sm">
      <CardHeader>
        <div className="flex items-center justify-between">
          ...
          <Button
            ...
            className="h-8 w-8 p-0 hover:bg-brand-purple/10 rounded-full"
          >
            <RefreshCw 
              className={`h-4 w-4 text-brand-purple ${isRefreshing ? 'animate-spin' : ''}`} 
            />
          </Button>
        </div>
      ...
      <CardContent className="space-y-6">
        {/* Detalhamento dos Saldos em Grid 4 colunas para Desktop */}
        <div className="grid grid-cols-2 gap-4">
          <div className="bg-blue-50/80 dark:bg-blue-900/30 rounded-lg p-4 border border-blue-200/60 dark:border-blue-700/60">
            <div className="flex items-center gap-2 mb-2">
              <Wallet className="w-5 h-5 text-blue-600 dark:text-blue-400" />
              <p className="text-sm font-medium text-blue-600 dark:text-blue-400">Carteira Digital</p>
            </div>
            ...
            <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Para recarga e upgrades</p>
          </div>

          <div className="bg-purple-50/80 dark:bg-purple-900/30 rounded-lg p-4 border border-purple-200/60 dark:border-purple-700/60">
            <div className="flex items-center gap-2 mb-2">
              <Crown className="w-5 h-5 text-purple-600 dark:text-purple-400" />
              <p className="text-sm font-medium text-purple-600 dark:text-purple-400">Saldo do Plano</p>
            </div>
            ...
            <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Para consultas</p>
          </div>

          <div className="bg-green-50/80 dark:bg-green-900/30 rounded-lg p-4 border border-green-200/60 dark:border-green-700/60">
            <div className="flex items-center gap-2 mb-2">
              <TrendingUp className="w-5 h-5 text-green-600 dark:text-green-400" />
              <p className="text-sm font-medium text-green-600 dark:text-green-400">Total em Recargas</p>
            </div>
            ...
            <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">PIX, cartão e Paypal</p>
          </div>

          <div className="bg-orange-50/80 dark:bg-orange-900/30 rounded-lg p-4 border border-orange-200/60 dark:border-orange-700/60">
            <div className="flex items-center gap-2 mb-2">
              <Users className="w-5 h-5 text-orange-600 dark:text-orange-400" />
              <p className="text-sm font-medium text-orange-600 dark:text-orange-400">Indicações</p>
              <Button
                variant="ghost"
                size="sm"
                onClick={() => {
                  console.log('🔍 [DEBUG] Estado atual das indicações:', referralStats);
                  loadReferralStats();
                  toast.info(`Debug: ${referralStats.totalReferrals} indicações, R$ ${referralStats.totalEarnings}`);
                }}
                className="h-6 w-6 p-0 text-xs"
                title="Debug das indicações"
              >
                🔍
              </Button>
            </div>
            ...
            <div className="flex items-center gap-2 mt-1">
              <Badge className="bg-orange-100 text-orange-700 dark:bg-orange-900/50 dark:text-orange-300 text-xs">
                {referralStats.totalReferrals} indicações válidas
              </Badge>
            </div>
          </div>
        </div>
        ...
        <div className="bg-blue-50/60 dark:bg-blue-900/20 rounded-lg p-4 border border-blue-200/40 dark:border-blue-700/40">
