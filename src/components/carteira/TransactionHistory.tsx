    ...
    <Card className="dark:bg-gray-800 dark:text-white w-full">
      <CardHeader>
        ...
        <CardDescription className="dark:text-gray-400">
          Suas transações recentes na carteira digital
        </CardDescription>
      </CardHeader>
        ...
        <div className="space-y-4 max-h-96 overflow-y-auto px-6 pb-6">
          {allTransactions && allTransactions.length > 0 ? (
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground">
                          ...
                          {transaction.document && ` • CPF: ${transaction.document}`}
                          {transaction.source_table && (
                            <span className="ml-2 text-xs bg-muted px-2 py-1 rounded">
                              {transaction.source_table === 'consultas_cpf' ? 'Legado' : 'Novo'}
                            </span>
                          )}
                        </p>
                        <p className="text-xs text-muted-foreground">
            ...
            <div className="text-center py-8 text-gray-500 dark:text-gray-400 px-6">
              ...
              <p className="text-sm">Suas transações aparecerão aqui após fazer recargas ou movimentações.</p>
            </div>
          )}
        </div>
      </CardContent>
